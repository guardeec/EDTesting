...
public class Controller implements Initializable {
    public static List<Result> resultList = new LinkedList<Result>();
    ...
    @FXML
    javafx.scene.control.TextArea resultText;
    ...
    private void calculate(){
        List<Functions> functionsLinkedList = new LinkedList<Functions>();
        List<Hacker>    hackerLinkedList    = new LinkedList<Hacker>();
        List<Rules>     rulesLinkedList     = new LinkedList<Rules>();
        ...
        try {
            ...
            while ((line=functional.readLine())!=null){
                ...
                List<String> hackerId = new LinkedList<String>();
